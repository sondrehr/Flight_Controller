...
Made on a 4 layer PCB where layer 2 and 3(not included in the img) are VCC and GND. The traces are split into a vertical layer(1) and horizontal layer(4) to make tracing easier.
